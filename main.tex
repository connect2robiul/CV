...
\begin{table}[H]
    ...
    \hline
     ...
     \textbf{Time} \\ \hline
Logic and Discrete mathematics & \multirow{3}{*} {Teaching Assistance} & \multirow{4}{*}{Innopolis University}& Fall 2021 \\ \cline{1-1} \cline{4-4} 

Neuroscience &       &   &  \multirow{2}{*}{Spring 2020} \\ \cline{1-1}
  Theoretical Computer Science & && \\      \cline{4-4} \cline{1-2}
        ...
        &  \multirow{3}{*}{Lecture}  & \multirow{3}{*}{Khwaja Yunus Ali University} &   \multirow{3}{*}{Fall 2016}  \\ \cline{1-1}
          Structure Programming &  &  & \\ \cline{1-1}
